...
export default function MetricSelect({ data, processed, selectedPoints, selectedDims, setSelectedDims, featureData, setFeatureData, zScores, setzScores, baselines, baselinesRef, setBaselines, fcs }) {
